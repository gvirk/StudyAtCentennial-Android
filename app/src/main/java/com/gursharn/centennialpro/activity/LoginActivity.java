...
public class LoginActivity extends Activity {
     ...
     * */
    private void checkLogin(final String user_name, final String user_pass) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String user_date = user.getString("user_date");

                        // Inserting row in users table
                        db.addUser(user_name, user_email, user_id, user_date);
