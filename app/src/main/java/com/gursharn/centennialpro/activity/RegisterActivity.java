...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String user_name = inputFullName.getText().toString().trim();
                String user_email = inputEmail.getText().toString().trim();
                String user_pass_check = inputPasswordagain.getText().toString().trim();
                String user_pass = inputPassword.getText().toString().trim();

                if (!user_name.isEmpty() && !user_email.isEmpty() && !user_pass.isEmpty() && !user_pass_check.isEmpty()) {
                    registerUser(user_name, user_email, user_pass, user_pass_check);
                } else {
     ...
     * */
    private void registerUser(final String user_name, final String user_email,
                              final String user_pass, final String user_pass_check) {
        ...
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("user_pass_check", user_pass_check);
